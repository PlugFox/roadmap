...
class Size extends OffsetBase {
  ...
  /// right edges.
  bool contains(Offset offset) => offset.dx >= 0.0 && offset.dx < width && offset.dy >= 0.0 && offset.dy < height;
  ...
  @override
  bool operator ==(Object other) => other is Size && other._dx == _dx && other._dy == _dy;
...
class Rect {
  ...
  td.Float32List getValue32() {
    final result = td.Float32List(4);
    result[0] = left;
    result[1] = top;
    result[2] = right;
    result[3] = bottom;
  ...
  bool get isInfinite =>
      left >= double.infinity || top >= double.infinity || right >= double.infinity || bottom >= double.infinity;
  ...
  Rect translate(double translateX, double translateY) =>
      Rect.fromLTRB(left + translateX, top + translateY, right + translateX, bottom + translateY);
  ...
  Rect intersect(Rect other) => Rect.fromLTRB(math.max(left, other.left), math.max(top, other.top),
  ...
  /// Rectangles include their top and left edges but exclude their bottom and
  /// right edges.
  bool contains(Offset offset) => offset.dx >= left && offset.dx < right && offset.dy >= top && offset.dy < bottom;
